    ...
    >
      ...
      <div className="mx-auto w-full max-w-[75rem] px-[1.875rem]">
        ...
        <ol
          ref={flowRef}
          data-process-flow
          className="relative max-[809px]:pl-5 max-[809px]:pr-0"
        >
          <span
            aria-hidden="true"
            data-process-mobile-track
            className="pointer-events-none absolute bottom-0 left-[-0.5rem] top-0 w-1 bg-black/10 min-[810px]:hidden"
          />
  ...
  return (
    ...
    >
      ...
      <span
        ...
        className="pointer-events-none absolute bottom-6 left-[-0.5rem] top-6 w-1 origin-top scale-y-0 bg-black min-[810px]:hidden"
      />
      ...
      >
        ...
        >
          ...
          />
          <h3 className="font-heading text-[clamp(1.5rem,2.5vw,2rem)] font-semibold leading-none tracking-[-0.03em]">
            {step.title}
          </h3>
        </div>
        <p
