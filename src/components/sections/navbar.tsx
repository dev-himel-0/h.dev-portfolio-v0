...
export function Navbar() {
  return (
    <header
      data-hero-nav
      className="absolute inset-x-0 top-0 z-20 flex items-center justify-between px-5 py-5 font-general sm:px-8 lg:pl-[clamp(2rem,2.3vw,2.5rem)] lg:pr-[clamp(2.75rem,3.3vw,3.5rem)] lg:pt-[1.25rem]"
    >
      <a
        href="#home"
